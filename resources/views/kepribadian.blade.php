                      ...
                      <div class="panel-body">
                          ...
                          <form class="form-horizontal" name="registration" id="default" enctype="multipart/form-data" ng-submit="submit()">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="radios">
                                             <label class="label_radio" for="laki">
                                                 <input style="color:gray" name="laki" id="laki" value="L" type="radio"  ng-model="data.jawab"> Laki - Laki
                                             </label>
                                             <label class="label_radio" for="perempuan">
                                                 <input style="color:gray" name="perempuan" id="perempuan" value="P" type="radio" ng-model="data.jawab"> Perempuan
                                             </label>
                                         </div>
                                     </div>
                                 </div>
                            ...
                            <fieldset title="Langkah 2" class="step" id="default-step-1" >
                              <legend> </legend>
                              <div>
                              <div class="form-group"  ng-repeat="ask in pertanyaanx">
                                <label class="col-lg-12 control-label"><%ask['pertanyaan']%></label>
                                <div ng-repeat="answer in jawabanx">
                                <div class="col-lg-10" ng-show="answer['idpertanyaan'] == ask['idpertanyaan']">
                                 <div ng-show="answer['idjawaban'] <=20">
                                     <label>
                                         <input type="radio" style="color:gray" name="<%answer['idpertanyaan']%>" id="<%answer['idpertanyaan']%>" value="<%answer['idjawaban']%>" type="radio"  ng-model="ask.jawabannya"><%answer['jawaban']%>
                                     </label>
                                 </div>
                                 <div ng-show="answer['idjawaban'] == 21">
                                     <label>
                                         <input type="radio"  ng-click="showDetails =true" style="color:gray" name="<%answer['idpertanyaan']%>" id="<%answer['idpertanyaan']%>" value="<%answer['idjawaban']%>" type="radio"  ng-model="ask.jawabannya"><%answer['jawaban']%>
                                     </label>
                                 </div>
                                 <div ng-show="answer['idjawaban'] == 22">
                                     <label>
                                         <input type="radio"  ng-click="showDetails =false" style="color:gray" name="<%answer['idpertanyaan']%>" id="<%answer['idpertanyaan']%>" value="<%answer['idjawaban']%>" type="radio"  ng-model="ask.jawabannya"><%answer['jawaban']%>
                                     </label>
                                 </div>
                                 ...
                                 <div ng-show="ask['idpertanyaan'] > 9">
                                  <label class="col-lg-12 control-label"><%ask['pertanyaan']%></label>
                                  <div ng-repeat="answer in jawabanx">
                                  <div class="col-lg-10" ng-show="answer['idpertanyaan'] == ask['idpertanyaan']">
