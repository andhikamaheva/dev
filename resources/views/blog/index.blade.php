...
<html lang="en">
  <head>
    ...
    <link href="css/blog/theme.css" rel="stylesheet">
    <link href="css/blog/bootstrap-reset.css" rel="stylesheet">
    <!--external css-->
    <link href="assets/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link rel="stylesheet" href="css/blog/flexslider.css"/>
    ...
    <link href="css/blog/style-responsive.css" rel="stylesheet" />
  ...
  <body>
        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.blade.php">Flat<span>Lab</span></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="index.blade.php">Home</a></li>
                        <li><a href="about.blade.php">About</a></li>
                        <li><a href="services.blade.php">Service</a></li>
                        <li class="dropdown ">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="button.blade.php">Buttons</a></li>
                            </ul>
                        </li>
                        <li><a href="portfolio.blade.php">Portfolio</a></li>
                        <li><a href="price.blade.php">Price</a></li>
    ...
    <script src="js/blog/jquery-1.8.3.min.js"></script>
    <script src="js/blog/bootstrap.min.js"></script>
    <script type="text/javascript" src="js/blog/hover-dropdown.js"></script>
    <script defer src="js/blog/jquery.flexslider.js"></script>
    <script type="text/javascript" src="assets/bxslider/jquery.bxslider.js"></script>

    <script type="text/javascript" src="js/blog/jquery.parallax-1.1.3.js"></script>

    <script src="js/jblog/query.easing.min.js"></script>
    <script src="js/blog/link-hover.js"></script>
    ...
    <script src="js/blog/common-scripts.js"></script>

    <script src="js/blog/revulation-slide.js"></script>
