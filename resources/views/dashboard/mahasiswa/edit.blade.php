...
@stop
@section('content')
  <section class="wrapper site-min-height" ng-controller="mahasiswaedit">
      <div class="row">
          <div class="col-lg-8 col-lg-offset-2">
              <section class="panel">
                  <header class="panel-heading">
                      <h1>Edit Data HMSI Apps!</h1>
                      <hr>
                      ...
                      <div class="panel-body">
                          ...
                          <hr>
                          <form class="form-horizontal" name="registration" id="default" enctype="multipart/form-data" ng-submit="submit(data.mhs_nim)">
                              <fieldset title="Step1" class="step" id="default-step-0">
                                  ...
                                  <div class="form-group" >
                                      ...
                                      <div class="col-lg-5">
                                        <input style="color:gray" type="text" value="" name="nim" ng-model="data.mhs_nim" class="form-control" ng-minlength="11" ng-maxlength="11"  placeholder="Masukkan 11 digit NIM" reqiured readonly disabled>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-8">
                                              <input style="color:gray" name="mhs_nama" type="text" ng-model="data.mhs_nama" class="form-control" placeholder="Nama Lengkap">
                                          </div>
                                      </div>
                                      <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="radios">
                                             <label class="label_radio" for="laki">
                                                 <input style="color:gray" name="laki" id="laki" value="L" type="radio"  ng-model="data.mhs_gender" ng-selected="data.mhs_gender == 'L'"> Laki - Laki
                                             </label>
                                             <label class="label_radio" for="perempuan">
                                                 <input style="color:gray" name="perempuan" id="perempuan" value="P" type="radio" ng-model="data.mhs_gender" ng-selected="data.mhs_gender == 'P'"> Perempuan
                                             </label>
                                         </div>
                                     </div>
                                 </div>
                            ...
                            <fieldset title="Step 2" class="step" id="default-step-1" >
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-lg-6">
                                      <input style="color:gray" type="text" ng-model="data.mhs_phone" class="form-control" placeholder="Nomor Telpon">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="col-lg-2 control-label">Email</label>
                                  <div class="col-lg-7">
                                      <input style="color:gray" type="email" ng-model="data.mhs_email" class="form-control" placeholder="Alamat Email">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="col-lg-2 control-label">Address</label>
                                  <div class="col-lg-10">
                                      <textarea style="color:gray" class="form-control" ng-model="data.mhs_alamat" cols="60" rows="5" placeholder="Alamat Rumah"></textarea>
                                  </div>
                              </div>
                              <div class="form-group">
                          ...
                          <fieldset title="Step 3" class="step" id="default-step-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                            <img src="{{URL('upload/images/profile')}}/<% data.mhs_photo %>" alt="" />
                                        </div>
                            ...
                            <div class="form-group">
                              <label class="col-lg-2 control-label">NIM</label>
                              <div class="col-lg-10">
                                  <p class="form-control-static" ng-bind="data.mhs_nim"></p>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-lg-2 control-label">Nama</label>
