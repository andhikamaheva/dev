         ...
         <div class="col-lg-4">
             ...
             <section class="panel">
                 <div class="panel-body">
                     ...
                     <img class="img-responsive" style="width:90px;height:83px;" src="{{URL('upload/images/profile/'.Auth::user()->mhs_photo)}}" alt="">
                     </a>
                     <div class="task-thumb-details col-md-7 col-xs-4 col-sm-4">
                         <h1><a href="{{URL('/mahasiswa/profile')}}">{{Auth::user()->mhs_nama}}</a></h1>
            ...
            <div class="col-lg-8">
                ...
                <div class="border-head">
                    <h3>Grafik Pengguna HMSI Apps!</h3>
                </div>
                <div class="custom-bar-chart">
                    ...
                    <div class="bar">
                        ...
                        <div class="value tooltips" data-original-title="150%" data-toggle="tooltip" data-placement="top">100%</div>
                    </div>
                    <div class="bar ">
